...
export class PlayerState extends Schema {
  ...
  //store keys yet to be processed server-side.
  public clientMoves: {};
  ...
  handleWalk(playerMove: any){
    ...
    this.z = this.z + z_move;
    this.rot = this.degrees_to_radians(rot);
    this.sequence = playerMove.seq;
  }
